...
aiError: 'فشل إنشاء الرؤى الذكية. حاول مرة أخرى.',
    ...
    reports: "التقارير",
    dailySummary: "الملخص",
    attendanceReport: "الحضور",
    clinicReport: "العيادة",
    epassReport: "التصاريح",
    receptionReport: "الاستقبال",
